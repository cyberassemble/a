...
$sk = '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';
$lista = $_GET['lista'];
...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount=100&currency=inr&payment_method_types[]=card');
...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1 Charged ✅ Checker By @itzNefoli <br>';
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY NEFOLI</span> <br>';
}
